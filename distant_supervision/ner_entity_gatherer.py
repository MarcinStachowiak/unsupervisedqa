...
from datashift import AbstractProcessingTask, AbstractReduceTask, AbstractFilterTask

from .data_models import PhraseObj, PhraseMode, Article
...
class NerEntityGatherer(AbstractProcessingTask):
...
class CountEntities(AbstractReduceTask):
    ...
    def reduce_globally(self, next_local_reduction_gen):
        ...
        for k,v in global_unique_entities.items():
            if v<NUM_ARTICLES_PER_ENTITY_LLIM:
